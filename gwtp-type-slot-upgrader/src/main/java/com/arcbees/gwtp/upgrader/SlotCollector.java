...
public class SlotCollector {
    ...
    public SlotCollector(File rootDir, boolean upgrade, JProgressBar progressBar,
            Label progressLabel) {
        ...
        ObjectSlotRewriter objectSlotRewriter = new ObjectSlotRewriter(
                contentSlotRewriter.getSlotNames(), upgrade);
        processDir(rootDir, objectSlotRewriter);
        progressBar.setValue(100);
        progressLabel
                .setText("Finished converting Project to GWTP " + (upgrade ? "2" : "1") + ".x");
    }
