...
/**
 * Common stubbing context for a {@link com.gwtplatform.dispatch.rest.delegates.client.ResourceDelegate
 * ResourceDelegate} call.
 *
...
public abstract class AbstractDelegateStubber<R, S extends AbstractDelegateStubber> {
    ...
    /**
     * Specify the {@link Response} that will be assigned to {@link com.gwtplatform.dispatch.rest.client
    ...
    /**
     * Specify the {@link DispatchRequest} that will be assigned to the {@link com.gwtplatform.dispatch.client
     * .DelegatingDispatchRequest
     * DelegatingDispatchRequest} that was passed to {@link com.gwtplatform.dispatch.rest.delegates.client
     * .ResourceDelegate#withDelegatingDispatchRequest(
     *com.gwtplatform.dispatch.client.DelegatingDispatchRequest) ResourceDelegate#withDelegatingDispatchRequest()}.
     *
     * @param dispatchRequest the {@link DispatchRequest} that will be passed to the configured {@link
