...
public class EndPointDelegateMethodProcessor extends DispatchRestContextProcessor<DelegateMethod, CodeSnippet>
        implements DelegateMethodProcessor {
    private static final String TEMPLATE =
            "com/gwtplatform/dispatch/rest/delegates/processors/EndPointDelegateMethod.vm";

    @Override
    public boolean canProcess(DelegateMethod context) {
        return context instanceof EndPointDelegateMethod;
    }
